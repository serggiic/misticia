...
public enum ArmorMaterialMisticita implements ArmorMaterial {
    MISTICITA("misticita", 45, Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
    ...
    ArmorMaterialMisticita(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionFunctionForType,
